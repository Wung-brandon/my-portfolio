...
export default function Home() {
  ...
  return (
    <motion.div
      ref={myRef}
      id="home"
      className="text-foreground flex flex-col lg:flex-row justify-center lg:justify-evenly items-center font-sans px-10 py-6 mt-3 lg:mt-20"
    >
      <div className="flex flex-col mb-14 text-center lg:text-left md:text-2xl">
        ...
        >
          ...
          and <br />
          web applications using cutting-edge technologies like React, Next.js,
          and Django.
        </motion.p>
        ...
        <motion.div
          ...
          variants={text2Variants}
        >
          <p className="text-light text-2xl">Interested in Working with Me?</p>
          <Link
            href="/"
            className="bg-accent text-light text-2xl hover:bg-primary hover:text-white px-5 py-3 rounded-md hover:scale-115"
          >
            Let's Connect
          </Link>
        </motion.div>
